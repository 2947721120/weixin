...
<div data-role="page" id="index">
    ...
    <div data-role="header" data-position="fixed" data-tap-toggle="false">
        ...
        <a href="${pageContext.request.contextPath}/mat/matOut" target="_top" class="ui-btn ui-btn-icon-notext ui-corner-all ui-icon-back ui-nodisc-icon ui-alt-icon ui-btn-right">返回</a>
    </div><!-- /header -->
        ...
        <div class="ui-body ui-body-a ui-corner-all">
            ...
            <div class="ui-grid-a">
                <div class="ui-block-a">
                    <div class="ui-bar ui-bar-a">
                        <label>出库日期：</label>
                        <label>${fn:substring(head.OutDT, 0, 10)}</label>
                    </div>
                </div>
                <div class="ui-block-b">
                    <div class="ui-bar ui-bar-a">
                        <label>出库仓库：</label>
                        <label>${head.StoreName}</label>
                    </div>
                </div>
            </div>
            <div class="ui-grid-a">
